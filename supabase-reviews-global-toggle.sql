-- ============================================================
-- Teamly — Toggle global d'avis depuis organizations.settings
-- ============================================================
-- Permet à l'admin d'activer/désactiver tous les avis depuis Paramètres.
-- La page tracking lit reviews_enabled depuis organizations.settings.reviewsEnabled.
...
AS $$
  SELECT
    ...
    o.review, o.rated_at,
    -- Combine global setting (organizations.settings.reviewsEnabled) + per-order toggle
    -- Default true if neither is set.
    COALESCE(
